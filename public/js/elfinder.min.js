...
(function (a) {
    window.elFinder = function (b, c) {
        ...
        var d = this, b = a(b), e = a("<div/>").append(b.contents()), f = b.attr("style"), g = b.attr("id") || "", h = "elfinder-" + (g || Math.random().toString().substr(2, 7)), i = "mousedown." + h, j = "keydown." + h, k = "keypress." + h, l = !0, m = !0, n = ["enable", "disable", "load", "open", "reload", "select", "add", "remove", "change", "dblclick", "getfile", "lockfiles", "unlockfiles", "dragstart", "dragstop"], o = {}, p = "", q = {path: "", url: "", tmbUrl: "", disabled: [], separator: "/", archives: [], extract: [], copyOverwrite: !0, tmb: !1}, r = {}, s = [], t = {}, u = {}, v = [], w = [], x = [], y = new d.command(d), z = "auto", A = 400, B = a(document.createElement("audio")).hide().appendTo("body")[0], C, D = function (b) {
            ...
            while (b--) {
                ...
                if (c.name && c.hash && c.mime) {
                    if (!c.phash) {
                        var e = "volume_" + c.name, f = d.i18n(e);
                        e != f && (c.i18 = f)
                    }
                    r[c.hash] = c
                }
        ...
        this.api = null, this.newAPI = !1, this.oldAPI = !1, this.OS = navigator.userAgent.indexOf("Mac") !== -1 ? "mac" : navigator.userAgent.indexOf("Win") !== -1 ? "win" : "other", this.UA = function () {
            ...
            return{ltIE6: typeof window.addEventListener == "undefined" && typeof document.documentElement.style.maxHeight == "undefined", ltIE7: typeof window.addEventListener == "undefined" && typeof document.querySelectorAll == "undefined", ltIE8: typeof window.addEventListener == "undefined" && typeof document.getElementsByClassName == "undefined", IE: document.uniqueID, Firefox: window.sidebar, Opera: window.opera, Webkit: a, Chrome: a && window.chrome, Safari: a && !window.chrome, Mobile: typeof window.orientation != "undefined"}
        ...
        }), this.compare = a.proxy(this.compare, this), this.notifyDelay = this.options.notifyDelay > 0 ? parseInt(this.options.notifyDelay) : 500, this.draggable = {appendTo: "body", addClasses: !0, delay: 30, revert: !0, refreshPositions: !0, cursor: "move", cursorAt: {left: 50, top: 47}, drag: function (a, b) {
            ...
            return d.trigger("dragstart", {target: e[0], originalEvent: b}), h = e.is("." + d.res("class", "cwdfile")) ? d.selected() : [d.navId2Hash(e.attr("id"))], f.append(g(r[h[0]].mime)).data("files", h).data("locked", !1), (i = h.length) > 1 && f.append(g(r[h[i - 1]].mime) + '<span class="elfinder-drag-num">' + i + "</span>"), f
            ...
            g.length && (c.helper.hide(), d.clipboard(g, !(b.ctrlKey || b.shiftKey || b.metaKey || c.helper.data("locked"))), d.exec("paste", j), d.trigger("drop", {files: f}))
            ...
            var b = r[a], c = b && b.tmb && b.tmb != 1 ? q.tmbUrl + b.tmb : "";
            ...
            if (g == "open")while (s = x.pop())s.state() == "pending" && (s.quiet = !0, s.abort());
            ...
            var b = this, c = a.Deferred().done(function () {
                b.trigger("sync")
            }), d = {data: {cmd: "open", init: 1, target: p, tree: this.ui.tree ? 1 : 0}, preventDefault: !0}, e = {data: {cmd: "tree", target: p == this.root() ? p : this.file(p).phash}, preventDefault: !0};
            return a.when(this.request(d), this.request(e)).fail(function (a) {
                c.reject(a), a && b.request({data: {cmd: "open", target: b.lastDir(""), tree: 1, init: 1}, notify: {type: "open", cnt: 1, hideCnt: !0}, preventDefault: !0})
            }).done(function (a, d) {
        ...
        a.extend(a.ui.keyCode, {F1: 112, F2: 113, F3: 114, F4: 115, F5: 116, F6: 117, F7: 118, F8: 119, F9: 120}), this.dragUpload = !1, this.xhrUpload = (typeof XMLHttpRequestUpload != "undefined" || typeof XMLHttpRequestEventTarget != "undefined") && typeof File != "undefined" && typeof FormData != "undefined", this.transport = {}, typeof this.options.transport == "object" && (this.transport = this.options.transport, typeof this.transport.init == "function" && this.transport.init(this)), typeof this.transport.send != "function" && (this.transport.send = function (b) {
            ...
            this.history(this), typeof this.options.getFileCallback == "function" && this.commands.getfile && (this.bind("dblclick", function (a) {
            ...
            m && d.enable()
        }}), cwd: a("<div/>").appendTo(b).elfindercwd(this, this.options.uiOptions.cwd || {}), notify: this.dialog("", {cssClass: "elfinder-dialog-notify", position: {top: "12px", right: "12px"}, resizable: !1, autoOpen: !1, title: "&nbsp;", width: 280}), statusbar: a('<div class="ui-widget-header ui-helper-clearfix ui-corner-bottom elfinder-statusbar"/>').hide().appendTo(b)}, a.each(this.options.ui || [], function (c, e) {
        ...
        }), g = "iframe-" + d.namespace + ++d.iframeCnt, h = a('<form action="' + d.uploadURL + '" method="post" enctype="multipart/form-data" encoding="multipart/form-data" target="' + g + '" style="display:none"><input type="hidden" name="cmd" value="upload" /></form>'), i = this.UA.IE, j = function () {
    ...
    }, _sortRules: {name: function (a, b) {
        return a.name.toLowerCase().localeCompare(b.name.toLowerCase())
    }, size: function (a, b) {
        var c = parseInt(a.size) || 0, d = parseInt(b.size) || 0;
        return c == d ? 0 : c > d ? 1 : -1
    }, kind: function (a, b) {
        return a.mime.localeCompare(b.mime)
    }, date: function (a, b) {
        var c = a.ts || a.date, d = b.ts || b.date;
        return c == d ? 0 : c > d ? 1 : -1
    }}, compare: function (a, b) {
        var c = this, d = c.sortType, e = c.sortOrder == "asc", f = c.sortStickFolders, g = c.sortRules, h = g[d], i = a.mime == "directory", j = b.mime == "directory", k;
        if (f) {
            if (i && !j)return-1;
            if (!i && j)return 1
        }
    ...
    }}, elFinder.prototype.version = "2.x (Nightly: bed75aa)", a.fn.elfinder = function (a) {
        ...
        this.not(".elfinder").each(function () {
            ...
            }), h = a(this).addClass("dialogelfinder").css("position", "absolute").hide().appendTo("body").draggable({handle: ".dialogelfinder-drag", containment: "window"}).elfinder(b).prepend(f), i = h.elfinder("instance");
        ...
        return this.each(function () {
            ...
            a.isArray(b.variants) && (k.addClass("elfinder-menubutton"), j = a('<div class="ui-widget ui-widget-content elfinder-button-menu ui-corner-all"/>').hide().appendTo(k).zIndex(12 + k.zIndex()).delegate("." + h, "hover",function () {
        ...
        return this.each(function () {
            ...
            b.one("load", function () {
                b.bind("contextmenu",function (a) {
                    var b = a.data;
                    i(), b.type && b.targets ? j(b.type, b.targets) : b.raw &&
                        k(b.raw), c.children().length && h(b.x, b.y)
        ...
        return this.not(".elfinder-cwd").each(function () {
            var d = b.viewType == "list", e = "undefined", f = "select." + b.namespace, g = "unselect." + b.namespace, h = "disable." + b.namespace, i = "enable." + b.namespace, j = "class", k = b.res(j, "cwdfile"), l = "." + k, m = "ui-selected", n = b.res(j, "disabled"), o = b.res(j, "draggable"), p = b.res(j, "droppable"), q = b.res(j, "hover"), r = b.res(j, "adroppable"), s = k + "-tmp", t = b.options.loadTmbs > 0 ? b.options.loadTmbs : 5, u = "", v = [], w = {icon: '<div id="{hash}" class="' + k + ' {permsclass} {dirclass} ui-corner-all" title="{tooltip}"><div class="elfinder-cwd-file-wrapper ui-corner-all"><div class="elfinder-cwd-icon {mime} ui-corner-all" unselectable="on" {style}/>{marker}</div><div class="elfinder-cwd-filename" title="{name}">{name}</div></div>', row: '<tr id="{hash}" class="' + k + ' {permsclass} {dirclass}" title="{tooltip}"><td><div class="elfinder-cwd-file-wrapper"><span class="elfinder-cwd-icon {mime}"/>{marker}<span class="elfinder-cwd-filename">{name}</span></div></td><td>{perms}</td><td>{date}</td><td>{size}</td><td>{kind}</td></tr>'}, x = b.res("tpl", "perms"), y = b.res("tpl", "symlink"), z = {permsclass: function (a) {
                ...
                var e = a.ui.keyCode, h = b == e.LEFT || b == e.UP, i = W.find("[id]." + m), j = h ? "first:" : "last", k, l, o, p, q;
                if (i.length) {
                    k = i.filter(h ? ":first" : ":last"), o = r(k, h ? "prev" : "next");
                    if (!o.length)l = k; else if (d || b == e.LEFT || b == e.RIGHT)l = o; else {
                ...
                var b = a.position().top, c = a.outerHeight(!0), d = X.scrollTop(), e = X.innerHeight();
                b + c > d + e ? X.scrollTop(parseInt(b + c - e)) : b < d && X.scrollTop(b)
            }, K = [], L = function (a) {
                var b = K.length;
                while (b--)if (K[b].hash == a)return b;
                return-1
            }, M = "scroll." + b.namespace, N = function () {
                var c = [], e = !1, g = [], h = {}, i = W.find("[id]:last"), j = !i.length, k = d ? W.children("table").children("tbody") : W, l;
            ...
            }, O = a.extend({}, b.droppable, {over: function (c, d) {
                var e = b.cwd().hash;
                ...
                c = c = a.splice(0, t), c.length && b.request({data: {cmd: "tmb", targets: c}, preventFail: !0}).done(function (b) {
                    Q(b.images || []) && R(a)
                })
            }, S = function (a) {
                var c = d ? W.find("tbody") : W, e = a.length, f = [], g = {}, h = !1, i = function (a) {
                    var c = W.find("[id]:first"), d;
                    while (c.length) {
                        d = b.file(c.attr("id"));
                    ...
                    var c = K.length, d;
                    for (d = 0; d < c; d++)if (b.compare(a, K[d]) < 0)return d;
                    return c || -1
                }, k, l, m, n;
                while (e--) {
                    k = a[e], l = k.hash;
            ...
            }, U = {name: b.i18n("name"), perm: b.i18n("perms"), mod: b.i18n("modify"), size: b.i18n("size"), kind: b.i18n("kind")}, V = function (e, f) {
                var g = b.cwd().hash;
                G();
                try {
                ...
                if (c.oldSchool && g && !u) {
                    var i = a.extend(!0, {}, b.file(g), {name: "..", mime: "directory"});
                ...
                var c = this.id ? a(this) : a(this).parents("[id]:first"), d = c.prevAll("." + m + ":first"), e = c.nextAll("." + m + ":first"), h = d.length, i = e.length, j;
            ...
            }, Z = a(this).parent().resize(Y), _ = Z.children(".elfinder-workzone").append(X.append(this));
            b.dragUpload && (X[0].addEventListener("dragenter", function (a) {
                ...
                a.preventDefault(), X.removeClass(r), a.dataTransfer && a.dataTransfer.files && a.dataTransfer.files.length && b.exec("upload", {files: a.dataTransfer.files})
                ...
                var c = b.selected(), e = b.storage("view") == "list";
                e != d && (d = e, V(b.files()), a.each(c, function (a, b) {
                    E(b)
                }), I()), Y()
            }).add(function (c) {
                var d = b.cwd().hash, e = u ? a.map(c.data.added || [], function (a) {
                ...
                var b = a.type == "lockfiles" ? h : i, c = a.data.files || [], d = c.length;
            ...
            }).shortcut({pattern: "ctrl+a", description: "selectall", callback: F}).shortcut({pattern: "left right up down shift+left shift+right shift+up shift+down", description: "selectfiles", type: "keydown", callback: function (a) {
        ...
        return this.not(".elfinder-navbar").each(function () {
            ...
            a.fn.resizable && (i = d.resizable({handles: h ? "e" : "w", minWidth: c.minWidth || 150, maxWidth: c.maxWidth || 500}).bind("resize scroll",function () {
                var a = b.UA.Opera && d.scrollLeft() ? 20 : 2;
                i.css({top: parseInt(d.scrollTop()) + "px", left: h ? "auto" : parseInt(d.scrollLeft() + a), right: h ? parseInt(d.scrollLeft() - a) * -1 : "auto"})
            }).find(".ui-resizable-handle").zIndex(d.zIndex() + 10), h || d.resize
            (function () {
        ...
        return this.each(function () {
            ...
            a('<span class="ui-icon ui-icon-search" title="' + b.title + '"/>').appendTo(d).click(e), a('<span class="ui-icon ui-icon-close"/>').appendTo(d).click(f), setTimeout(function () {
                ...
                if (b.fm.UA.ltIE7) {
                    ...
                    a.css({right: "", left: parseInt(d.width()) - a.outerWidth(!0)})
                }
        ...
        return this.each(function () {
            ...
            }), m = a('<div class="ui-widget ui-widget-content elfinder-button-menu ui-corner-all"/>').hide().appendTo(l).zIndex(12 + l.zIndex()).delegate("." + h, "hover",function () {
                a(this).toggleClass(g)
            ...
            a.each(c.sortRules, function (b, d) {
                ...
                b.exec([], {type: e, order: e == c.sortType ? c.sortOrder == "asc" ? "desc" : "asc" : c.sortOrder, stick: c.sortStickFolders})
            }), a('<div class="' + h + " " + h + '-separated"><span class="ui-icon ui-icon-check"/>' + c.i18n("sortFoldersFirst") + "</div>").appendTo(m).click(function () {
                b.exec([], {type: c.sortType, order: c.sortOrder, stick: !c.sortStickFolders})
        ...
        return this.each(function () {
            var c = a(this).addClass("elfinder-stat-size"), d = a('<div class="elfinder-stat-selected"/>'), e = b.i18n("size").toLowerCase(), f = b.i18n("items").toLowerCase(), g = b.i18n("selected"
            ), h = function (d, g) {
                var h = 0, i = 0;
        ...
        return this.not("." + d).each(function () {
            var e = "class", f = b.res(e, "treeroot"), g = c.openRootOnLoad, h = b.res(e, "navsubtree"), i = b.res(e, "treedir"), j = b.res(e, "navcollapse"), k = b.res(e, "navexpand"), l = "elfinder-subtree-loaded", m = b.res(e, "navarrow"), n = b.res(e, "active"), o = b.res(e, "adroppable"), p = b.res(e, "hover"), q = b.res(e, "disabled"), r = b.res(e, "draggable"), s = b.res(e, "droppable"), t = function (a) {
            ...
            }}), w = a(b.res("tpl", "navspinner")), x = b.res("tpl", "navdir"), y = b.res("tpl", "perms"), z = b.res("tpl", "symlink"), A = {id: function (a) {
                ...
                var c = a.length, d = [], e = a.length, f, g, h, i;
                while (e--) {
                    f = a[e];
                ...
                var d = b.cwd().hash, e = J.find("#" + b.navHash2Id(d)), j, m;
                ...
                if (c.syncTree) {
                    ...
                    if (b.newAPI) {
                        ...
                        b.request({data: {cmd: "parents", target: d}, preventFail: !0}).done(function (a) {
                            var c = C(a.tree);
            ...
            }, J = a(this).addClass(d).delegate("." + i, "hover",function (c) {
                ...
                c.stopPropagation(), e.is("." + l) ? (e.toggleClass(k), f.slideToggle()) : (w.insertBefore(d), e.removeClass(j), b.request({cmd: "tree", target: b.navId2Hash(e.attr("id"))}).done(function (a) {
            ...
            b.open(function (a) {
                var b = a.data, c = C(b.files);
                b.init && J.empty(), c.length && (F(c), I(c, l)), G()
            }).add(function (a) {
                var b = C(a.data.added);
                b.length && (F(b), I(b, j))
            }).change(function (c) {
                var d = C(c.data.changed), e = d.length, f, g, j, m, n, o, p, q, r;
                while (e--) {
                    f = d[e];
        ...
        this.variants = [], this.disableOnSearch = !0, c.bind("open reload", function () {
            ...
            var f = this.files(b), g = f.length, h = e || d[0], i = c.cwd(), j = ["errArchive", "errPerm", "errCreatingTempDir", "errFtpDownloadFile", "errFtpUploadFile", "errFtpMkdir", "errArchiveExec", "errExtractExec", "errRm"], k = a.Deferred()
                .fail(function (a) {
                    a && c.error(a)
                }), l;
        ...
        this.shortcuts = [
            ...
            var a = this.fm.selected(), b = a.length;
        ...
        this.disableOnSearch = !0, c.bind("open reload", function () {
            ...
            var e = this.files(b), f = a.Deferred(), g = e.length, h, i, j, k = !1, l = !1, m = a.map(c.files(b), function (a) {
                return a.name
            }), n = {};
            a.map(c.files(b), function (a) {
                n[a.name] = a
            });
            var o = function (a) {
                switch (a) {
                ...
                !b.read || !c.file(b.phash).write ? (i = ["errExtract", b.name, "errPerm"], c.error(i), f.reject(i)) : a.inArray(b.mime, d) === -1 ? (i = ["errExtract", b.name, "errNoArchive"], c.error(i), f.reject(i)) : c.request({data: {cmd: "extract", target: b.hash}, notify: {type: "extract", cnt: 1}, syncOnFail: !0}).fail(function (a) {
                    f.isRejected() || f.reject(a)
                }).done(function () {
                })
            }, q = function (b, d) {
                var e = b[d], i = e.name.replace(/\.((tar\.(gz|bz|bz2|z|lzo))|cpio\.gz|ps\.gz|xcf\.(gz|bz2)|[a-z0-9]{1,4})$/ig, ""), r = a.inArray(i, m) >= 0;
                r && n[i].mime != "directory" ? c.confirm({title: c.i18n("ntfextract"), text: c.i18n(["errExists", i, "confirmRepl"]), accept: {label: "btnYes", callback: function (a) {
                    j = a ? "overwrite_all" : "overwrite", o(j);
                    if (!k && !l)"overwrite" == j && p(e), d + 1 < g ? q(b, d + 1) : f.resolve(); else if (k) {
                        for (h = 0; h < g; h++)p(b[h]);
                        f.resolve()
                    }
                }}, reject: {label: "btnNo", callback: function (a) {
                    j = a ? "omit_all" : "omit", o(j), !k && !l && d + 1 < g ? q(b, d + 1) : l && f.resolve()
                }}, cancel: {label: "btnCancel", callback: function () {
                    f.resolve()
                }}, all: g > 1}) : (p(e), d + 1 < g ? q(b, d + 1) : f.resolve())
            };
        ...
        this.alwaysEnabled = !0, this.updateOnSelect = !1, this.state = 0, this.shortcuts = [
            ...
            a.each(d, function (a, c) {
                p.push(o[k](/\{id\}/, c)[k](/\{title\}/, b.i18n(c)))
            }), p.push("</ul>"), a.inArray("about", d) !== -1 && s(), a.inArray("shortcuts", d) !== -1 && t(), a.inArray("help", d) !== -1 && u(), p.push("</div>"), v = a(p.join("")), b.one("load", function () {
                v.find("#apiver").text(b.api)
            }), v.find(".ui-tabs-nav li").hover(function () {
                a(this).toggleClass("ui-state-hover")
            }).children().click(function (b) {
                var c = a(this);
                b.preventDefault(), b.stopPropagation(), c.is(".ui-tabs-selected") || (c.parent().addClass("ui-tabs-selected ui-state-active").siblings().removeClass("ui-tabs-selected").removeClass("ui-state-active"), v.find(".ui-tabs-panel").hide().filter(c.attr("href")).show())
            }).filter(":first").click()
        }, 200), this.getstate = function () {
            return 0
        }, this.exec = function () {
            this.dialog || (this.dialog = this.fm.dialog(v, {title: this.title, width: 530, autoOpen: !1, destroyOnClose: !1})), this.dialog.elfinderdialog("open").find(".ui-tabs-nav li a:first").click()
        }
        ...
        this.tpl = {main: '<div class="ui-helper-clearfix elfinder-info-title"><span class="elfinder-cwd-icon {class} ui-corner-all"/>{title}</div><table class="elfinder-info-tb">{content}</table>', itemTitle: '<strong>{name}</strong><span class="elfinder-info-kind">{kind}</span>', groupTitle: "<strong>{items}: {num}</strong>", row: "<tr><td>{label} : </td><td>{value}</td></tr>", spinner: '<span>{text}</span> <span class="' + d + '"/>'}, this.alwaysEnabled = !0, this.updateOnSelect = !1, this.shortcuts = [
            ...
            j == 1 ? (v = i[0], l = l.replace("{class}", f.mime2class(v.mime)), w = g.itemTitle.replace("{name}", f.escape(v.i18 || v.name)).replace("{kind}", f.mime2kind(v)), v.tmb && (u = f.option("tmbUrl") + v.tmb), v.read ? v.mime != "directory" || v.alias ? t = f.formatSize(v.size) : (t = g.spinner.replace("{text}", e.calc), p.push(v.hash)) : t = e.unknown, k.push(h.replace(m, e.size).replace(n, t)), v.alias && k.push(h.replace(m, e.aliasfor).replace(n, v.alias)), k.push(h.replace(m, e.path).replace(n, f.escape(f.path(v.hash, !0)))), v.read && k.push(h.replace(m, e.link).replace(n, '<a href="' + f.url(v.hash) + '" target="_blank">' + v.name + "</a>")), v.dim ? k.push(h.replace(m, e.dim).replace(n, v.dim)) : v.mime.indexOf("image") !== -1 && (v.width && v.height ? k.push(h.replace(m, e.dim).replace(n, v.width + "x" + v.height)) : (k.push(h.replace(m, e.dim).replace(n, g.spinner.replace("{text}", e.calc))), f.request({data: {cmd: "dim", target: v.hash}, preventDefault: !0}).fail(function () {
                ...
                q(a.dim || e.unknown)
            }))), k.push(h.replace(m, e.modify).replace(n, f.formatDate(v))), k.push(h.replace(m, e.perms).replace(n, f.formatPermissions(v)))
                , k.push(h.replace(m, e.locked).replace(n, v.locked ? e.yes : e.no))) : (l = l.replace("{class}", "elfinder-cwd-icon-group"), w = g.groupTitle.replace("{items}", e.items).replace("{num}", j), x = a.map(i,function (a) {
        ...
        this.alwaysEnabled = !0, this.updateOnSelect = !1, this.drivers = [], this.handlers = {load: function () {
            ...
            var c = b.fm, d = a.Deferred(), e = function () {
                var e = {protocol: a("<select/>"), host: a('<input type="text"/>'), port: a('<input type="text"/>'), path: a('<input type="text" value="/"/>'), user: a('<input type="text"/>'), pass: a('<input type="password"/>')}, f = {title: c.i18n("netMountDialogTitle"), resizable: !1, modal: !0, destroyOnClose: !0, close: function () {
                    delete b.dialog, d.state() == "pending" && d.reject()
                }, buttons: {}}, g = a('<table class="elfinder-info-tb elfinder-netmount-tb"/>');
                return a.each(b.drivers, function (a, b) {
                    e.protocol.append('<option value="' + b + '">' + c.i18n(b) + "</option>")
                }), a.each(e, function (b, d) {
                    b != "protocol" && d.addClass("ui-corner-all"), g.append(a("<tr/>").append(a("<td>" + c.i18n(b) + "</td>")).append(a("<td/>").append(d)))
                }), f.buttons[c.i18n("btnMount")] = function () {
                    var c = {cmd: "netmount"};
                    a.each(e, function (b, d) {
                        var e = a.trim(d.val());
                        e && (c[b] = e)
                    });
                    if (!c.host)return b.fm.trigger("error", {error: "errNetMountHostReq"});
                    b.fm.request({data: c, notify: {type: "netmount", cnt: 1}}).done(function () {
                        d.resolve()
                    }).fail(function (a) {
                        d.reject(a)
                    }), b.dialog.elfinderdialog("close")
                }, f.buttons[c.i18n("btnCancel")] = function () {
                    b.dialog.elfinderdialog("close")
                }, c.dialog(g, f)
            };
            return b.dialog || (b.dialog = e()), d.promise()
        }
        ...
        this.alwaysEnabled = !0, this._handlers = {dblclick: function (a) {
            ...
            while (f--) {
                ...
                (h = c.url(g.hash)) || (h = c.options.url, h = h + (h.indexOf("?") === -1 ? "?" : "&") + (c.oldAPI ? "cmd=open&current=" + g.phash : "cmd=file") + "&target=" + g.hash), g.dim ? (i = g.dim.split("x"), j = "width=" + (parseInt(i[0]) + 20) + ",height=" + (parseInt(i[1]) + 20)) : j = "width=" + parseInt(2 * a(window).width() / 3) + ",height=" + parseInt(2 * a(window).height() / 3);
            ...
            var c = this, d = c.fm, b = b ? this.files(b)[0] : d.cwd(), e = d.clipboard(), f = e.length, g = f ? e[0].cut : !1, h = g ? "errMove" : "errCopy", i = [], j = [], k = a.Deferred().fail(function (a) {
                ...
                var f = a.Deferred(), h = [], i = function (b, c) {
                    ...
                    j = c[0].phash, c = a.map(c, function (a) {
                        ...
                        f.resolve(), d.unlockfiles({files: c})
                    })
                };
        ...
        var b = this, c = b.fm, d = 0, e = 1, f = 2, g = d, h = "elfinder-quicklook-navbar-icon", i = "elfinder-quicklook-fullscreen", j = function (b) {
            ...
            var b = document.createElement(a.substr(0, a.indexOf("/"))), c = !1;
            try {
            ...
            d.stopPropagation(), f ? (e.css(e.data("position")).unbind("mousemove"), j.unbind(g).trigger(b.resize).unbind(b.resize), v.unbind("mouseenter").unbind("mousemove")) : (e.
                data("position", {left: e.css("left"), top: e.css("top"), width: e.width(), height: e.height()}).css({width: "100%", height: "100%"}), a(window).bind(g,function () {
        ...
        this.updateOnSelect = !1, this.getstate = function () {
            ...
            var c = this.fm, d = this.files(b), e = a.Deferred(), f = function (b, d) {
                var f = a('<div class="elfinder-dialog-resize"/>'), g = '<input type="text" size="5"/>', h = '<div class="elfinder-resize-row"/>', i = '<div class="elfinder-resize-label"/>', j = a('<div class="elfinder-resize-control"/>'), k = a('<div class="elfinder-resize-preview"/>'), l = a('<div class="elfinder-resize-spinner">' + c.i18n("ntfloadimg") + "</div>"), m = a('<div class="elfinder-resize-handle"/>'), n = a('<div class="elfinder-resize-handle"/>'), o = a('<div class="elfinder-resize-uiresize"/>'), p = a('<div class="elfinder-resize-uicrop"/>'), q = '<div class="ui-widget-content ui-corner-all elfinder-buttonset"/>', r = '<div class="ui-state-default elfinder-button"/>', s = '<span class="ui-widget-content elfinder-toolbar-button-separator"/>', t = a('<div class="elfinder-resize-rotate"/>'), u = a(r).attr("title", c.i18n("rotate-cw")).append(a('<span class="elfinder-button-icon elfinder-button-icon-rotate-l"/>').click(function () {
                ...
                }}, ba = {mouseStartAngle: 0, imageStartAngle: 0, imageBeingRotated: !1, update: function (a, b) {
                    typeof a == "undefined" && (S = a = parseInt(H.val())), typeof b == "undefined" && (b = !0), !b || c.UA.Opera || c.UA.ltIE8 ? X.rotate(a) : X.animate({rotate: a + "deg"}), a %= 360, a < 0 && (a += 360), H.val(parseInt(a)), I.slider("value", H.val())
                }, execute: function (a) {
                    if (!ba.imageBeingRotated)return;
                    var b = ba.getCenter(X), c = a.pageX - b[0], d = a.pageY - b[1], e = Math.atan2(d, c), f = e - ba.mouseStartAngle +
                        ba.imageStartAngle;
                    ...
                    var c = ba.getCenter(X), d = b.pageX - c[0], e = b.pageY - c[1];
                    ...
                    a.fn.resizable && (b ? (m.filter(":ui-resizable").resizable("destroy"), m.hide()) : (m.show(), m.resizable({alsoResize: T, aspectRatio: N, resize: Z.update, stop: Z.fixHeight})))
                }, bc = function (b) {
                    a.fn.draggable && a.fn.resizable && (b ? (n.filter(":ui-resizable").resizable("destroy"), n.filter(":ui-draggable").draggable("destroy"), U.hide()) : (V.width(T.width()).height(T.height()), W.width(T.width()).height(T.height()), n.width(V.width()).height(V.height()).offset(V.offset()).resizable({containment: U, resize: _.resize_update, handles: "all"}).draggable({handle: n, containment: V, drag: _.update}), U.show().width(T.width()).height(T.height()), _.update()))
                }, bd = function (b) {
                ...
                }, bf = {}, bg = "elfinder-resize-handle-hline", bh = "elfinder-resize-handle-vline", bi = "elfinder-resize-handle-point", bj = c.url(b.hash);
                ...
                }, bf[c.i18n("btnApply")] = be, c.dialog(f, {title: b.name, width: 650, resizable: !1, destroyOnClose: !0, buttons: bf, open: function () {
                    k.zIndex(1 + a(this).parent().zIndex())
                }}).attr("id", d), c.UA.ltIE8 && a(".elfinder-dialog").css("filter", ""), x.css("left", B.position().left + B.width() + 12), W.css({opacity: .2, "background-color": "#fff", position: "absolute"}), n.css("cursor", "move"), n.find(".elfinder-resize-handle-point").css({"background-color": "#fff", opacity: .5, "border-color": "#000"}), X.css("cursor", "pointer"), y.buttonset(), O = k.width() - (m.outerWidth() - m.width()), P = k.height() - (m.outerHeight() - m.height()), T.attr("src", bj + (bj.indexOf("?") === -1 ? "?" : "&") + "_=" + Math.random()), V.attr("src", T.attr("src")), X.attr("src", T.attr("src"))
            }, g, h;
        ...
        this.shortcuts = [
            ...
            return!g || this._disabled ? e.reject() : (a.each(f, function (a, b) {
                ...
                if (b.locked)return!
                    e.reject(["errLocked", b.name]);
                b.hash == h && (i = d.root(b.hash))
            }), e.state() == "pending" && (f = this.hashes(b), d.confirm({title: c.title, text: "confirmRm", accept: {label: "btnRm", callback: function () {
        ...
        this.options = {ui: "sortbutton"}, this.getstate = function () {
            ...
            var d = this.fm, c = a.extend({type: d.sortType, order: d.sortOrder, stick: d.sortStickFolders}, c);
